...
class HybridRetriever:
    ...
    def retrieve(
        ...
        Steps:
        1. BM25 retrieval (top candidate_pool)
        2. Dense embedding retrieval (top candidate_pool)
        3. RRF merge
        4. Signal quality boosts
        5. Source diversity cap
        """
        # Step 1 & 2: Parallel retrieval
        bm25_ranked = self._bm25_retrieve(query, top_k=candidate_pool)
        dense_ranked = self._dense_retrieve(query, top_k=candidate_pool)
